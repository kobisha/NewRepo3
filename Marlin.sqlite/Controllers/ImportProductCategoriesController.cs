...
namespace Marlin.sqlite.Controllers
{
    ...
    public class ImportProductCategoriesController : ControllerBase
    {
        ...
        public ImportProductCategoriesController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Post()
        {
            ...
            string filePath = "ProductCategories.json";
            string jsonData = System.IO.File.ReadAllText(filePath);
            JObject data = JObject.Parse(jsonData);

            // Extract data for Table1
            var table1Data = data["json"].ToObject<List<ProductCategories>>();

            // Extract data for Table2
            // var table2Data = data["Products"].ToObject<List<OrderDetails>>();

            // Insert data into Table1
            _context.ProductCategories.AddRange(table1Data);
